...
const shirts: Record<string, { id: string; name: string; price: number; image: string; type: string }[]> = {
  manu:     [ { id: 'manu1', name: 'Home 2024/25',    price: 319.90, image: 'https://images.unsplash.com/photo-1551489186-cf8726f514f8?w=600', type: 'Titular'  }, { id: 'manu2', name: 'Away 2024/25',   price: 299.90, image: 'https://images.unsplash.com/photo-1579952363873-27f3bade9f55?w=600', type: 'Visitante'}, { id: 'manu3', name: 'Third 2023/24', price: 279.90, image: 'https://images.unsplash.com/photo-1560272564-c83b66b1ad12?w=600', type: 'Terceiro' }],
